			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<p class="field-icon description description-thin">
					<label for="edit-menu-item-icon-<?php echo $item_id; ?>">
						<?php _e( 'Icon', 'wpc' ); ?><br />
						<input type="text" id="edit-menu-item-icon-<?php echo $item_id; ?>" class="iconpicker widefat code edit-menu-item-icon" name="menu-item-icon[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->icon ); ?>" />
					</label>
				</p>
				<?php if ($depth == 0) { ?>
				<p class="field-mega-menu description description-thin">
					<label for="edit-menu-item-mega-menu-<?php echo $item_id; ?>">
						<?php _e( 'Mega Menu', 'wpc' ); ?><br />
